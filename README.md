...
Этот template вырос из реальной CI-инфраструктуры проекта **[ИИкона](https://github.com/andromanpro/1c-ai-connector)** — открытый AI-коннектор для 1С:Предприятие. От первого прогона на ноутбуке до зелёного Gitea Actions с Allure dashboard — за один рабочий день. Подробный разбор пути — в статье [**«Я хотел CI для тестов 1С. Получил шесть граблей и одну DeepSeek-галлюцинацию»**](https://androman.pro/2026/05/14/ci-1c-za-den/) (зеркала на Хабре / Инфостарте — позже).
